...
libc6-dev-arm64-cross/noble,noble,now 2.39-0ubuntu8cross1 all [installed,automatic]
libc6-dev-armhf-cross/noble,noble,now 2.39-0ubuntu8cross1 all [installed,automatic]
libc6-dev/noble-updates,noble-security,now 2.39-0ubuntu8.6 amd64 [installed]
